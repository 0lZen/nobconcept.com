...
$res = CIBlockElement::GetList(['XML_ID'=>'ASC'],["IBLOCK_ID"=>CATALOG_IBLOCK_ID,"ACTIVE"=>'Y'],false,false,
...
if (!empty($arParents))
{
    ...
    while($arFields = $res->Fetch())
    {
        if (!isset($arSku[$arFields["PROPERTY_CML2_LINK_VALUE"]]))
        {
            $arSku[$arFields["PROPERTY_CML2_LINK_VALUE"]]=[
                'ID'            => $arFields["ID"],
