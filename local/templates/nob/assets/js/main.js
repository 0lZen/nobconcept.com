...
$(document).ready(function(){
  ...
  $('.slides-controls__item').on('click', function(e){
    ...
    $('.js-lang-mobile').click(function(){
        var language_dir = $(this).data('dir');
        if (language_dir != siteDir)
        {
            var newHref=document.location.pathname.substr(siteDir.length);
            document.location.href = language_dir+newHref;
        }
    })
  /* \Sliders */
    ...
    $(selectbox_class).each(function(index){
      ...
      $(this).customSelect({
        ...
        hideCallback: function(){
          ...
          {
            var language_dir = $('.languages option:selected').val();
...
$(document).on('click', '.cart-end__side_en .button', function(e){
  ...
  $('.navigation-menu__item', '#navigation_header').on('mouseover click', function(e){
    ...
    var current_page = $('.subnavigation-menu__page[data-id="'+curID+'"]', '#subnavigation');
