...
<div class="block__inner">
	...
	<div class="block-catalog__top i-pc">
        ...
        <?
        /*if(strpos($APPLICATION->GetCurDir(), (LANGUAGE_ID === 'ru' ? '/' : '/' . LANGUAGE_ID . '/') . 'catalog/') === 0){
            ?>
            ...
            <?
        }elseif(strpos($APPLICATION->GetCurDir(), (LANGUAGE_ID === 'ru' ? '/' : '/' . LANGUAGE_ID . '/') . 'pre-order/') === 0){
            ?><div class="block-catalog__menu catalog-menu i-noselect">
                <a onclick="return true;" href="/catalog/" class="catalog-menu__item catalog-menu__item_active" title="<?=GetMessage('ALL')?>"><?=GetMessage('ALL')?></a>
                <a onclick="return true;" href="<?if (LANGUAGE_ID == 'ru'){echo '/catalog/men/';}else{echo '/en/catalog/men/';}?>" class="catalog-menu__item " title="<?=GetMessage('MEN')?>"><?=GetMessage('MEN')?></a>
                <a onclick="return true;" href="<?if (LANGUAGE_ID == 'ru'){echo '/catalog/women/';}else{echo '/en/catalog/women/';}?>" class="catalog-menu__item " title="<?=GetMessage('WOMAN')?>"><?=GetMessage('WOMAN')?></a>
            </div><?
        }elseif(strpos($APPLICATION->GetCurDir(), (LANGUAGE_ID === 'ru' ? '/' : '/' . LANGUAGE_ID . '/') . 'sale/') === 0){
            ?><div class="block-catalog__menu catalog-menu i-noselect">
                <a onclick="return true;" href="/catalog/" class="catalog-menu__item catalog-menu__item_active" title="<?=GetMessage('ALL')?>"><?=GetMessage('ALL')?></a>
                <a onclick="return true;" href="<?if (LANGUAGE_ID == 'ru'){echo '/catalog/men/';}else{echo '/en/catalog/men/';}?>" class="catalog-menu__item " title="<?=GetMessage('MEN')?>"><?=GetMessage('MEN')?></a>
                <a onclick="return true;" href="<?if (LANGUAGE_ID == 'ru'){echo '/catalog/women/';}else{echo '/en/catalog/women/';}?>" class="catalog-menu__item " title="<?=GetMessage('WOMAN')?>"><?=GetMessage('WOMAN')?></a>
