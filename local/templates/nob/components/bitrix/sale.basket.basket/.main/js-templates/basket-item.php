...
<script id="basket-item-template" type="text/html">
 				...
 				<div class="cart-scheme__row" id="basket-item-{{ID}}" data-entity="basket-item" data-id="{{ID}}">
	              <div class="cart-scheme__cell cart-scheme__cell_photo">
	                <img alt="{{NAME}}" class="cart-scheme__preview i-lazy loaded" src="{{{IMAGE_URL}}}{{^IMAGE_URL}}<?=$templateFolder?>/images/no_photo.png{{/IMAGE_URL}}" data-src="{{{IMAGE_URL}}}{{^IMAGE_URL}}<?=$templateFolder?>/images/no_photo.png{{/IMAGE_URL}}" data-src-mobile="{{{IMAGE_URL}}}{{^IMAGE_URL}}<?=$templateFolder?>/images/no_photo.png{{/IMAGE_URL}}" data-was-processed="true">
	              </div>
	              <div class="cart-scheme__cell cart-scheme__cell_info">
	                <div class="cart-product__content">
	                  <h3 class="cart-product__brand">{{BRAND}}</h3>
	                  <h4 class="cart-product__title">{{NAME}}</h4>
	                  <div class="cart-product__color i-pc">{{TSVET}}</div>
	                ...
	                <a href="{{DETAIL_PAGE_URL}}" class="cart-product__link" title="{{BRAND}} | {{NAME}}">{{BRAND}} | {{NAME}}</a>

	              </div>
	              <div class="cart-scheme__cell cart-scheme__cell_size"><div class="cart-scheme__value">{{RAZMER}}</div></div>
	              <div class="cart-scheme__cell cart-scheme__cell_price">
	              	<div class="cart-scheme__value" id="basket-item-price-{{ID}}">
	              		<div class="cart-scheme__old-price">6 600 <span class="i-currency">₽</span></div>
	              		<div class="cart-scheme__price">{{{PRICE_FORMATED}}}</div>
	              	</div>
	              </div>


	              <div class="cart-scheme__cell cart-scheme__cell_num"><div class="cart-scheme__value">{{QUANTITY}}</div></div>

	              <div class="cart-scheme__cell cart-scheme__cell_total"><div class="cart-scheme__value" id="basket-item-sum-price-{{ID}}">{{{SUM_PRICE_FORMATED}}}</div></div>
	              <div class="cart-scheme__cell cart-scheme__cell_controls">
					...
					{{#DELAYED}}
	                  <a href="javascript:void(0)" class="cart-scheme__control cart-scheme__control_favorite i-add-to-favorite_active" title="Убрать из избранного" data-text-success="Товар добавлен в избранное" data-text-fail="Товар убран из избранного" data-remove-text="Убрать из избранного" data-add-text="В избранное">Убрать из избранного</a>
	                {{/DELAYED}}


	                  <div class="i-clear"></div>
	                  <a href="javascript:void(0)" class="cart-scheme__control cart-scheme__control_remove" title="Удалить" data-entity="basket-item-delete">Удалить</a>
	                </div>
	              </div>
