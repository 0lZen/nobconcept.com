...
<script id="basket-total-template" type="text/html">
 ...
 <div class="cart-end" data-entity="basket-checkout-aligner">
    ...
    <div class="cart-end__side">
	    <a href="#cart-order" class="button button_important" data-source="Корзина" title="Оформить заказ">Оформить заказ на сумму:
