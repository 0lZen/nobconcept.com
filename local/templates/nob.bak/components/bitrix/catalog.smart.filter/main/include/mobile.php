<div class="modal modal_form" id="catalog-filter">
    <div class="modal__wrapper">
        <div class="modal__outer">
            <div class="close i-lazy" onclick='reloadClose();' <?/*data-izimodal-close*/?> data-bg="url(<?=SITE_TEMPLATE_PATH?>/assets/css/images/icons/close.svg)"></div>

            <div class="catalog-filter__header"><?echo GetMessage("CT_BCSF_FILTER_TITLE")?></div>

            <?require($_SERVER["DOCUMENT_ROOT"].'/includes/catalog_menu.php'); ?>

            <div class="block-catalog__filter _mobile">
                                ...
                                <div class="filter-group filter-group_inline filter-group_color">
                                    <div class="filter-group__inner">
                                        <?foreach ($arItem["VALUES"] as $val => $ar):?>
                                            ...
                                            if($ar['VALUE']=='Синий'):
                                                $ar['VALUE']='0000FF';
                                            elseif($ar['VALUE']=='Желтый'):
                                                $ar['VALUE']='fdff00';
                                            elseif($ar['VALUE']=='Черный'):
                                                $ar['VALUE']='000000';
                                            elseif($ar['VALUE']=='Белый'):
                                                $ar['VALUE']='eaeaea';
                                            elseif($ar['VALUE']=='Красный'):
                                                $ar['VALUE']='ff0000';
                                            elseif($ar['VALUE']=='Зелёный'):
                                                $ar['VALUE']='15ff00';
                                            elseif($ar['VALUE']=='Голубой'):
                                                $ar['VALUE']='00ffdf';
                                            elseif($ar['VALUE']=='Бордовый'):
                                                $ar['VALUE']='800000';
                                            elseif($ar['VALUE']=='Розовый'):
                                                $ar['VALUE']='ff7bb0';
                                            elseif($ar['VALUE']=='Серый'):
                                                $ar['VALUE']='8d8d8d';
                                            elseif($ar['VALUE']=='Бежевый'):
                                                $ar['VALUE']='e0e094';
                                            elseif($ar['VALUE']=='Мультиколор'):
                                                $ar['VALUE']='c6f2ff';
                                                $bgImageItem = '/upload/images/img-multicolor.png';
                                            elseif($ar['VALUE']=='Оранжевый'):
                                                $ar['VALUE']='ffa500';
                                            elseif($ar['VALUE']=='Сиреневый'):
                                                $ar['VALUE']='c8a2c8';
                                            elseif($ar['VALUE']=='Фиолетовый'):
                                                $ar['VALUE']='8b00ff';
                                            elseif($ar['VALUE']=='Хаки'):
                                                $ar['VALUE']='806b2a';
                                            elseif($ar['VALUE']=='Коричневый'):
                                                $ar['VALUE']='964b00';
                                            elseif($ar['VALUE']=='Бирюзовый'):
                                                $ar['VALUE']='30d5c8';
                                    ...
                                    <div class="filter-group__inner">
                                        <?foreach($arItem["VALUES"] as $val => $ar):
                                            ...
                                            <div class="filter-checkbox <?if($ar['CHECKED']): echo 'filter-checkbox_active'; endif;?>" data-value="<? echo $ar["CONTROL_ID"] ?>">
                                                ...
                                                <div class="filter-checkbox__name<? echo $ar["DISABLED"] ? ' disabled': '' ?>"  title="<?=$ar["VALUE"];?>"><?=$ar["VALUE"];?></div>
                                                <span style="color: #969696;font-size: .6em;margin: 0 0 0 .33em">(</span>
                                                <div data-role="count_<?=$ar["CONTROL_ID"]?>" style="margin: 0" class="filter-checkbox__additional"><?=$ar["ELEMENT_COUNT"]?></div>
                                                <span style="color: #969696;font-size: .6em;">)</span>
            ...
            <div class="catalog-filter__end _mobile" id="mobile-filter-prods-shower" style="display:none">
                <?/*<a href="<?echo $arResult["FILTER_URL"]?>"><?echo GetMessage("CT_BCSF_FILTER_SHOW")?></a>*/?>
                <!-- Показать <span class='modef_main'>выбранные</span> <span class='modef_main_text'>товары</span> -->
                <div onclick='reloadTarget();' class="catalog-filter__button">
                    <? if (SITE_ID == 's1') { ?>
                        Показать результат
                    <? } else { ?>
                        Show result
