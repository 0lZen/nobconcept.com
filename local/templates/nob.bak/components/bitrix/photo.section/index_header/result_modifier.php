...
foreach ($arResult['ITEMS'] as $k => $arItem)
{
    ...
    {
      $arResult['ITEMS'][$k]['PREVIEW_PC'] = ImageBx::ResizeImageGet($arItem['PROPERTIES']['IMAGE_PC']['VALUE'][0], array('width' => 891, 'height' => 1274),'crop');
    ...
    {
      $arResult['ITEMS'][$k]['PREVIEW_MOBILE'] = ImageBx::ResizeImageGet($arItem['PROPERTIES']['IMAGE_MOBILE']['VALUE'][0], array('width' => 580, 'height' => 770),'crop');
    }
    elseif ($preview_pc_exists)
    {
      $arResult['ITEMS'][$k]['PREVIEW_MOBILE'] = ImageBx::ResizeImageGet($arItem['PROPERTIES']['IMAGE_PC']['VALUE'][0], array('width' => 580, 'height' => 770),'crop');
    }
    else
    {
