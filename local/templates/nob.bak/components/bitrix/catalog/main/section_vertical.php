...
<div class="block-catalog__top catalog-top i-mobile i-noselect">
      ...
      <div class="block-catalog__sort catalog-sort i-noselect">
      	<a href="//test.nobagency.com/catalog/index.php?bitrix_include_areas=N&amp;clothing=suits&amp;sort_by=new&amp;sort_order=desc" class="catalog-sort__item  catalog-sort__item_desc" data-value="new" title="<?=GetMessage("SORT_BY_MIN")?>"><?=GetMessage("SORT_BY_NEWS")?><span class="catalog-sort__direction">&nbsp;</span></a>
      	<a href="//test.nobagency.com/catalog/index.php?bitrix_include_areas=N&amp;clothing=suits&amp;sort_by=new&amp;sort_order=asc" class="catalog-sort__item  catalog-sort__item_asc" data-value="new" title="<?=GetMessage("SORT_BY_MAX")?>"><?=GetMessage("SORT_BY_NEWS")?><span class="catalog-sort__direction">&nbsp;</span></a>
      	<a href="//test.nobagency.com/catalog/index.php?bitrix_include_areas=N&amp;clothing=suits&amp;sort_by=price&amp;sort_order=desc" class="catalog-sort__item  catalog-sort__item_desc" data-value="price" title="<?=GetMessage("SORT_BY_MIN")?>"><?=GetMessage("SORT_BY_PRICE")?><span class="catalog-sort__direction">&nbsp;</span></a>
      	<a href="//test.nobagency.com/catalog/index.php?bitrix_include_areas=N&amp;clothing=suits&amp;sort_by=price&amp;sort_order=asc" class="catalog-sort__item  catalog-sort__item_asc" data-value="price" title="<?=GetMessage("SORT_BY_MAX")?>"><?=GetMessage("SORT_BY_PRICE")?><span class="catalog-sort__direction">&nbsp;</span></a>
      </div>
      </div>
</div>
