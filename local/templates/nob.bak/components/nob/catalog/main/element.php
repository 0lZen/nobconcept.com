...
$this->addExternalCss(SITE_TEMPLATE_PATH.'/assets/css/first-product.min.css');
$this->addExternalCss(SITE_TEMPLATE_PATH.'/assets/css/first-catalog.min.css');
?>
		<?
$arParams['DETAIL_OFFERS_PROPERTY_CODE'][] = "TSVETT";
$arParams['DETAIL_OFFERS_PROPERTY_CODE'][] = "RAZMER";
            //echo "1<pre>"; print_r($arParams['LINK_IBLOCK_TYPE']); echo "</pre>";
			//echo "2<pre>"; print_r($arParams['LINK_IBLOCK_ID']); echo "</pre>";
			//echo "3<pre>"; print_r($arParams['LINK_PROPERTY_SID']); echo "</pre>";
			//echo "4<pre>"; print_r($arParams['LINK_IBLOCK_ID']); echo "</pre>";
			//echo "5<pre>"; print_r($arParams['DETAIL_OFFERS_PROPERTY_CODE']); echo "</pre>";
