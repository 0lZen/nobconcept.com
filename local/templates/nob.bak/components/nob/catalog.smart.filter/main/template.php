...
<style>
    ...
    <form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
        ...
        foreach($arResult["ITEMS"] as $key=>$arItem)
        {
            ...
            <div class="filter-category i-noselect <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>filter-category_opened<?endif?>">
                <div class="filter-category__header">
                    <div class="filter-category__title"><div class="filter-category__arrow i-lazy" data-bg="url(/local/templates/nob/assets/css/images/icons/arrow.svg)" data-was-processed="true" style="background-image: url(&quot;/local/templates/nob/assets/css/images/icons/arrow.svg&quot;);"></div><?=$arItem["NAME"]?></div>
                        ...
                        <div class="filter-group__inner">
                            <?foreach ($arItem["VALUES"] as $val => $ar):?>
                                ...
                                if ($ar["DISABLED"])
                                    $class.= " disabled";
                                ?>
                                <label for="<?=$ar["CONTROL_ID"]?>" data-role="label_<?=$ar["CONTROL_ID"]?>" class="filter-checkbox filter-checkbox_color <?if($ar['CHECKED']): echo 'filter-checkbox_active'; endif;?>" onclick="smartFilter.keyup(BX('<?=CUtil::JSEscape($ar["CONTROL_ID"])?>')); BX.toggleClass(this, 'active');">

                                    <div class="filter-checkbox__radio" style="background:#<?=$ar['VALUE']?>;"></div>
                        ...
                        <div class="filter-group__inner">
                            <?foreach($arItem["VALUES"] as $val => $ar):
                                ...
                                <div class="filter-checkbox <?if($ar['CHECKED']): echo 'filter-checkbox_active'; endif;?>" data-value="<? echo $ar["CONTROL_ID"] ?>">
                                    ...
                                    <label data-role="label_<?=$ar["CONTROL_ID"]?>" class="filter-checkbox__radio <? echo $ar["DISABLED"] ? 'disabled': '' ?>" for="<? echo $ar["CONTROL_ID"] ?>">
                                    ...
                                    <div class="filter-checkbox__name"  title="<?=$ar["VALUE"];?>"><?=$ar["VALUE"];?></div>
                                    <div data-role="count_<?=$ar["CONTROL_ID"]?>" class="filter-checkbox__additional">(<?=$ar["ELEMENT_COUNT"]?>)</div>
