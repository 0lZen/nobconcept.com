...
function Favorites_Add(sku_id)
{
    ...
    arFav.push(sku_id);
    $.cookie("favorites_"+siteDir, JSON.stringify(arFav), { expires: 30000, path: "/"});
...
function Favorites_Del(sku_id)
{
    ...
    $.cookie("favorites_"+siteDir, JSON.stringify(arFavNew), { expires: 30000, path: "/"});
...
{
    var favCookie=$.cookie("favorites_"+siteDir);
    if (favCookie)
    {
