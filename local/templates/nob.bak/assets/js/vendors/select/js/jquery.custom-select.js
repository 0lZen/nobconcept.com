...
var CustomSelect = function ($) {
  ...
  function () {
    ...
    _proto._init = function _init() {
      ...
      this._$dropdownInner = this._$element.find("." + this._options.block + "__dropdown-inner"); // Render options
      ...
      $.each(this._values, function (i, el) {
        ...
        if (el === _this._$select.find(':selected').text().trim()) {
          ...
          if (_this._options.includeValue || _this._options.placeholder) {
            ...
            _this._$dropdownInner.append($option);
          }
        } else {
          $option.addClass(cssClass);
      ...
      this._$options = this._$dropdownInner.find("." + this._options.block + "__option");
    ...
    _proto._search = function _search() {
      ...
      this._$dropdownInner.prepend(this._$input); // Add scrollable wrap
    ...
    _proto._dropup = function _dropup() {
      ...
      var documentToSelectboxSpaceDif = $(document).height() - ($(this._$element[0]).offset().top + $(this._$element[0]).height() + this._$dropdown.height()); // free document bottom space
      var windowToSelectboxSpaceDif = ($(window).scrollTop() + this._options.topspace) - ($(this._$element[0]).offset().top - this._$dropdown.height());

      var up = $(window).height() - bottom < this._$dropdown.height();
      console.log(($(window).scrollTop() + this._options.topspace)+' - '+($(this._$element[0]).offset().top - this._$dropdown.height())); //this._options.topspace

      if (documentToSelectboxSpaceDif >= 0 && up && windowToSelectboxSpaceDif > 0)
      {
        up = false;
      }
