...
$MESS["SHOW_MORE"] = "Показать ещё товары";
$MESS["EMPTY_PRODUCTS"] = "В данном разделе пока нет товаров. Перейти в <a href=\"/catalog/\">каталог</a>";
$MESS["EMPTY_SEARCH"] = "Товары не найдены. Перейти в <a href=\"/catalog/\">каталог</a>";
?>