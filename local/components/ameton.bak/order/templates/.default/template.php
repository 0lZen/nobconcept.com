        ...
        <div class="modal__content-inner">
            ...
            <div class="modal__main">
                <div class="form__fields">
                    ...
                    <select class="form__select form__input_required selectbox js-order-form-delivery js-order-form-select" onchange="put_hidden(this.options[this.selectedIndex].value);"
                    ...
                    <div class="form__input form__input_addr form__input_required i-lazy js-order-form-field-container" data-bg="url(<?=SITE_TEMPLATE_PATH?>/assets/css/images/forms/fields/addr.svg)">
                        <textarea id="fid-addr" name="ADDRESS" class="js-order-form-field" value="<?=$elFields["VALUE"]?>" placeholder="<?=GetMessage('INPUT_TITLE_ADDR')?>"></textarea>
                    </div>
                </div>
